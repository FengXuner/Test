...
let ReflectionObject = require(24);
((Enum.prototype = Object.create(ReflectionObject.prototype)).constructor = Enum).className = "Enum";

let Namespace = require(23),
    util = require(37);
...
let ruleRe = /^required|optional|repeated$/;
...
"use strict";
let protobuf = module.exports = require(18);
...
// extends Field
let Field = require(16);
((MapField.prototype = Object.create(Field.prototype)).constructor = MapField).className = "MapField";

let types   = require(36),
    util    = require(37);
